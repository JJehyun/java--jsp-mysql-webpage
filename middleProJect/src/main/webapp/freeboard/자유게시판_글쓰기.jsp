...
<link href="freeboardcss/writenotice.css" rel="stylesheet">
</head>
<body>
<style>
...
<form id="frm" action="http://localhost:8080/middleProJect/freeboard/자유게시판글쓰기_확인.jsp" method="post" enctype="multipart/form-data">
<center><table>
        <tr>
            <td>제목:</td>
